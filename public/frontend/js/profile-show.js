    ...
    function registerAlpineComponents(Alpine) {
        ...
        Alpine.data('profileShowPage', (config = {}) => ({
            ...
            async submitReport(event) {
                const form = event && event.target ? event.target : document.getElementById('report-form');
        ...
        Alpine.data('nearbySlider', (total = 0) => ({
            ...
            get totalPages() {
                if (!this.total || !this.itemsPerView) return 0;
            ...
            handleResize() {
                ...
                this.$nextTick(() => {
                    ...
                    if (previousItemsPerView !== this.itemsPerView && this.page > this.totalPages - 1) {
            ...
            goTo(index) {
                ...
                if (Number.isNaN(safeIndex)) return;
                if (safeIndex < 0 || safeIndex >= this.totalPages) return;
