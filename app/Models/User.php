...
class User extends Authenticatable implements FilamentUser, HasAvatar, MustVerifyEmail
{
    ...
    public function canAccessPanel(Panel $panel): bool
    {
        return match ($panel->getId()) {
            'admin' => $this->role === self::ROLE_ADMIN || $this->role === self::ROLE_REVIEWER,
            default => false,
        };
    }
    ...
    {
        return $this->hasOne(ProviderProfile::class)->orderBy('id');
    }
    ...
    {
        return $this->hasOne(AvailableNow::class);
    }
    ...
    {
        return $this->hasOne(SetAndForget::class);
    }
    ...
    public function purchaseComplaints(): HasMany
    {
        return $this->hasMany(PurchaseComplaint::class);
    }

    public function accountRestoreRequests(): HasMany
    {
        return $this->hasMany(AccountRestoreRequest::class);
    }
