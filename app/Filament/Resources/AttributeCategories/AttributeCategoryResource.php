...
class AttributeCategoryResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Attribute Category';
    ...
    {
        $parentId = static::getAttributesParentId();
        ...
        return $schema
            ->components([
                Hidden::make('parent_id')
                    ->default(fn (): ?int => static::getAttributesParentId())
                    ->dehydrated(true),
    ...
    {
        $data['parent_id'] = static::getAttributesParentId();
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->striped()
            ->emptyStateHeading('No Attributes categories yet')
            ->emptyStateDescription('Create child categories under Attributes from here.');
    }

    public static function getPages(): array
    {
        return [
            'index' => ManageAttributeCategories::route('/'),
        ];
    }

    protected static function getAttributesParentId(): ?int
    {
        return Category::query()
            ->where('slug', 'attributes')
            ->value('id');
    }
}
