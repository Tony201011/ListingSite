...
class TimeWasterShieldCategoryResource extends Resource
{
    protected static ?string $model = Category::class;

    protected static string|BackedEnum|null $navigationIcon = Heroicon::OutlinedShieldCheck;

    protected static ?string $navigationLabel = 'Use time waster shield for SMS?';

    protected static ?string $modelLabel = 'Time Waster Shield Category';
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->striped()
            ->emptyStateHeading('No time waster shield categories yet')
            ->emptyStateDescription('Create child categories under Use time waster shield for SMS? from here.');
    }

    public static function getPages(): array
    {
        return [
            'index' => ManageTimeWasterShieldCategories::route('/'),
        ];
    }
