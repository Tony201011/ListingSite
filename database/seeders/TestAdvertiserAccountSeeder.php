...
class TestAdvertiserAccountSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $profile->fill([
            ...
            'profile_sequence' => 1,
            'age' => 29,
            'description' => 'Demo advertiser profile for testing only. All content and contact details are fictitious.',
            'introduction_line' => 'Demo advertiser account for QA and sandbox verification.',
            'profile_text' => 'This advertiser account exists only for testing. Do not use with real customer data.',
