...
<head>
    ...
    <title>Account Restoration Request Received</title>
</head>
                ...
                <table role="presentation" width="640" cellspacing="0" cellpadding="0" style="max-width:640px;width:100%;background:#ffffff;border:1px solid #f1f5f9;border-radius:14px;overflow:hidden;">
                    <tr>
                        <td style="background:linear-gradient(90deg,#e04ecb,#c13ab0);padding:24px 28px;">
                            ...
                            <div style="font-size:14px;color:#fdf2f8;margin-top:6px;">Account restoration request received</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:28px;">
                            ...
                            <p style="margin:0 0 18px 0;font-size:15px;line-height:1.7;color:#4b5563;">
                                We have received your request to restore your account. Our team will review your request and get back to you as soon as possible.
                            </p>

                            <div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:10px;padding:14px 16px;margin-bottom:18px;">
                                <div style="font-size:12px;text-transform:uppercase;letter-spacing:0.08em;color:#166534;margin-bottom:6px;font-weight:700;">Request Details</div>
                                <div style="font-size:14px;color:#111827;">
                                    <strong>Email:</strong> {{ $email }}<br>
                                    @if($submittedAt)
                                    <strong>Submitted:</strong> {{ $submittedAt->format('M d, Y h:i A') }}
                                    @endif
                                </div>
                            </div>
