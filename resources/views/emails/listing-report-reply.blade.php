...
<head>
    ...
    <title>Re: Your Listing Report</title>
</head>
                    ...
                    <tr>
                        <td style="background-color:#e04ecb;padding:24px 28px;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                ...
                                <tr>
                                    <td style="font-size:14px;color:#fdf2f8;padding-top:6px;font-family:Arial,Helvetica,sans-serif;">Response to your listing report</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    <td style="font-size:22px;font-weight:700;color:#111827;padding-bottom:10px;font-family:Arial,Helvetica,sans-serif;">
                                        Hello, {{ $report->reporter_name ?? 'there' }}!
                                    </td>
                                </tr>
                                <tr>
                                    <td style="font-size:14px;color:#4b5563;padding-bottom:20px;font-family:Arial,Helvetica,sans-serif;">
                                        Thank you for submitting your listing report. Here is our response:
                                    </td>
                                </tr>
                                        ...
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#f9fafb;border:1px solid #e5e7eb;border-radius:10px;">
                                            <tr>
                                                <td style="padding:16px 20px;">
                                                    <p style="font-size:13px;color:#6b7280;margin:0 0 6px 0;font-family:Arial,Helvetica,sans-serif;font-weight:600;text-transform:uppercase;letter-spacing:0.05em;">Your original report</p>
                                                    <p style="font-size:14px;color:#374151;margin:0 0 4px 0;font-family:Arial,Helvetica,sans-serif;">
                                                        <strong>Reported Listing:</strong> {{ $report->providerListing?->title ?? '—' }}
                                                    </p>
                                                    <p style="font-size:14px;color:#374151;margin:0 0 4px 0;font-family:Arial,Helvetica,sans-serif;">
                                                        <strong>Reason:</strong> {{ ucwords(str_replace('_', ' ', $report->reason)) }}
                                                    </p>
                                                    @if(filled($report->description))
                                                    <p style="font-size:14px;color:#374151;margin:0;line-height:1.6;font-family:Arial,Helvetica,sans-serif;">
                                        ...
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#fdf2f8;border:1px solid #fbcfe8;border-radius:10px;">
                                            <tr>
                                                <td style="padding:20px;">
                                                    ...
                                                    <p style="font-size:15px;color:#374151;margin:0;line-height:1.6;font-family:Arial,Helvetica,sans-serif;">{{ $report->admin_reply }}</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
