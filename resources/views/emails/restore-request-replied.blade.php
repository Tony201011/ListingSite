...
<head>
    ...
    <title>Update on Your Account Restoration Request</title>
</head>
                ...
                <table role="presentation" width="640" cellspacing="0" cellpadding="0" style="max-width:640px;width:100%;background:#ffffff;border:1px solid #f1f5f9;border-radius:14px;overflow:hidden;">
                    <tr>
                        <td style="background:linear-gradient(90deg,#e04ecb,#c13ab0);padding:24px 28px;">
                            ...
                            <div style="font-size:14px;color:#fdf2f8;margin-top:6px;">Update on your account restoration request</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:28px;">
                            ...
                            <p style="margin:0 0 18px 0;font-size:15px;line-height:1.7;color:#4b5563;">
                                Our team has reviewed your account restoration request and has left a message for you.
                            </p>

                            @if($adminReply)
                            <div style="background:#fef9c3;border:1px solid #fde68a;border-radius:10px;padding:14px 16px;margin-bottom:18px;">
                                <div style="font-size:12px;text-transform:uppercase;letter-spacing:0.08em;color:#92400e;margin-bottom:6px;font-weight:700;">Message from Admin</div>
