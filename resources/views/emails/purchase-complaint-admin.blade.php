...
<head>
    ...
    <title>New Purchase Complaint</title>
</head>
                    ...
                    <tr>
                        <td style="background-color:#e04ecb;padding:24px 28px;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                ...
                                <tr>
                                    <td style="font-size:14px;color:#fdf2f8;padding-top:6px;font-family:Arial,Helvetica,sans-serif;">New purchase complaint received</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                ...
                                <tr>
                                    <td style="font-size:14px;color:#4b5563;padding-bottom:20px;font-family:Arial,Helvetica,sans-serif;">
                                        A provider has submitted a complaint about a purchase transaction. Details are below:
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding:0;">
                                                    ...
                                                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                                        <tr>
                                                            <td style="font-size:15px;color:#1f2937;padding:6px 0;font-family:Arial,Helvetica,sans-serif;">
                                                                <strong style="color:#111827;">Provider Name:</strong>&nbsp; {{ $complaint->user?->name ?? '-' }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="font-size:15px;color:#1f2937;padding:6px 0;font-family:Arial,Helvetica,sans-serif;">
                                                                <strong style="color:#111827;">Provider Email:</strong>&nbsp; {{ $complaint->user?->email ?? '-' }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="font-size:15px;color:#1f2937;padding:6px 0;font-family:Arial,Helvetica,sans-serif;">
                                                                <strong style="color:#111827;">Transaction ID:</strong>&nbsp; #{{ $complaint->purchase_transaction_id }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="font-size:15px;color:#1f2937;padding:6px 0;font-family:Arial,Helvetica,sans-serif;">
                                                                <strong style="color:#111827;">Transaction Amount:</strong>&nbsp; ${{ number_format($complaint->purchaseTransaction?->amount ?? 0, 2) }} {{ $complaint->purchaseTransaction?->currency ?? 'AUD' }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="font-size:15px;color:#1f2937;padding:6px 0;font-family:Arial,Helvetica,sans-serif;">
                                                                <strong style="color:#111827;">Subject:</strong>&nbsp; {{ $complaint->subject }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                                            <tr>
                                                <td style="background-color:#e04ecb;border-radius:999px;">
                                                    <a href="mailto:{{ $complaint->user->email }}" style="display:inline-block;padding:12px 24px;font-size:14px;font-weight:700;color:#ffffff;text-decoration:none;font-family:Arial,Helvetica,sans-serif;">
                                                        Reply to Provider
                                                    </a>
                                                </td>
                                            </tr>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    <td style="font-size:12px;color:#6b7280;font-family:Arial,Helvetica,sans-serif;">
                                        This email was sent from the HOTESCORT purchase complaint system.
                                    </td>
                                </tr>
                            </table>
                        </td>
