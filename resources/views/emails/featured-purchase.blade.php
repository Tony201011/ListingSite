...
<head>
    ...
    <title>{{ $isExtension ? 'Ad Placement Extended' : 'Ad Placement Activated' }}</title>
</head>
                ...
                <table role="presentation" width="640" cellspacing="0" cellpadding="0" style="max-width:640px;width:100%;background:#ffffff;border:1px solid #f1f5f9;border-radius:14px;overflow:hidden;">
                    <tr>
                        <td style="background:linear-gradient(90deg,#e04ecb,#c13ab0);padding:24px 28px;">
                            ...
                            <div style="font-size:14px;color:#fdf2f8;margin-top:6px;">{{ $isExtension ? 'Ad Placement Extended' : 'Ad Placement Activated' }}</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:28px;">
                            <h1 style="margin:0 0 10px 0;font-size:24px;line-height:1.3;color:#111827;">
                                {{ $isExtension ? 'Your ad has been extended,' : 'Your ad is now live,' }} {{ $name }}!
                            </h1>
                            <p style="margin:0 0 18px 0;font-size:15px;line-height:1.7;color:#4b5563;">
                                @if($isExtension)
                                    Your <strong>{{ $tierLabel }}</strong> placement has been extended successfully.
                                @else
                            ...
                            <div style="background:#fdf2f8;border:1px solid #fbcfe8;border-radius:10px;padding:14px 16px;margin-bottom:18px;">
                                <div style="font-size:12px;text-transform:uppercase;letter-spacing:0.08em;color:#9d174d;margin-bottom:10px;font-weight:700;">Placement Details</div>
                                <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td style="font-size:14px;color:#6b7280;padding:4px 0;">Ad Placement</td>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" style="margin:0 0 20px 0;">
                                <tr>
                                    <td style="background:#e04ecb;border-radius:999px;">
                                        <a href="{{ $featuredUrl }}" style="display:inline-block;padding:12px 22px;font-size:14px;font-weight:700;color:#ffffff;text-decoration:none;">Manage Ad Placements</a>
                                    </td>
                                </tr>
                            </table>
