                    ...
                    <tr>
                        <td style="background-color:#e04ecb;padding:24px 28px;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                ...
                                <tr>
                                    <td style="font-size:14px;color:#fdf2f8;padding-top:6px;font-family:Arial,Helvetica,sans-serif;">Response to your report</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                ...
                                <tr>
                                    <td style="font-size:14px;color:#4b5563;padding-bottom:20px;font-family:Arial,Helvetica,sans-serif;">
                                        Thank you for submitting your report. Here is our response:
                                    </td>
                                </tr>
                                            ...
                                            <tr>
                                                <td style="padding:16px 20px;">
                                                    ...
                                                    <p style="font-size:14px;color:#374151;margin:0 0 4px 0;font-family:Arial,Helvetica,sans-serif;">
                                                        <strong>Reported Profile:</strong> {{ $report->providerProfile?->name ?? '—' }}
                                                    </p>
                                                    <p style="font-size:14px;color:#374151;margin:0 0 4px 0;font-family:Arial,Helvetica,sans-serif;">
