        ...
        <div class="bg-white rounded-2xl p-6 md:p-10 shadow-md border border-gray-100">
            <form method="POST" action="#">
                ...
                <div class="mb-6">
                    ...
                    <input type="email"
                           ...
                           class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-[#9f7aea] focus:ring-2 focus:ring-[#9f7aea]/20 transition bg-gray-50 focus:bg-white"
                           required>
                </div>
                ...
                <button type="submit"
                        class="w-full bg-gradient-to-r from-[#9f7aea] to-[#6b46c1] text-white font-bold text-xl py-4 rounded-full shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition transform duration-200">
                    Reset password
                </button>
            </form>
            ...
            <div class="text-center border-t border-gray-200 mt-8 pt-6">
                <p class="text-gray-500 text-sm">
                    <a href="#" class="text-[#9f7aea] font-medium border-b border-dotted border-[#9f7aea] hover:text-[#6b46c1] hover:border-[#6b46c1] transition">
                        Login Here
                    </a>
                </p>
            </div>
