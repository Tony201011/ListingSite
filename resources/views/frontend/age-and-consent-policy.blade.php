...
<div class="min-h-screen bg-gray-50 py-10 px-4 sm:px-6 lg:px-8">
    <div class="max-w-5xl mx-auto">
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8 mb-6">
            <h1 class="text-3xl sm:text-4xl font-bold text-gray-900 tracking-tight">Age and Consent Policy</h1>
            <p class="mt-3 text-gray-600">Read our age verification requirements and consent standards for using this platform.</p>
        ...
        @else
            <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6 text-gray-500">
                Age and consent policy is not available yet.
            </div>
        @endif
    </div>
</div>
