...
<div class="min-h-screen bg-gray-50" x-data="{}">
    <main class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div class="min-h-[600px] rounded-lg bg-white p-6 shadow-sm sm:p-8">
            ...
            <h1 class="text-3xl font-bold text-gray-900">{{ $page?->title ?: 'How Credits Work' }}</h1>
            <p class="mt-2 mb-8 text-gray-600">{{ $page?->subtitle ?: 'Learn how credits are used to keep your listing live and visible on the platform.' }}</p>
