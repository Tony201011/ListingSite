...
<div class="min-h-screen bg-gray-100 text-gray-800">
    ...
    >
        ...
        {{-- Hidden when a local banner is active (location-filtered page) --}}
        @if(!empty($homeBannerProfiles) && count($homeBannerProfiles) > 0 && (empty($localBannerProfiles) || count($localBannerProfiles) === 0))
            <div class="mb-6">
