...
<div class="min-h-screen bg-gray-50" x-data="{}">
    <main class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div class="min-h-[600px] rounded-lg bg-white p-6 shadow-sm sm:p-8">
            ...
            <h1 class="text-3xl font-bold text-gray-900">{{ $page?->title ?: 'Help' }}</h1>
            <p class="mt-2 text-gray-600 {{ $page?->updated_at ? 'mb-2' : 'mb-8' }}">{{ $page?->subtitle ?: 'Find quick support links for account, profile, and billing related questions.' }}</p>
            @if($page?->updated_at)
