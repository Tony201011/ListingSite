...
@endpush
                ...
                <div class="order-1 flex min-w-0 flex-col gap-4 sm:gap-6 md:order-2">
                    ...
                    @endif
                      ...
                      <a
                            href="{{ route('report-a-listing', ['listing_url' => request()->url(), 'listing_id' => $profile['id'], 'advertiser_name' => $profile['name']]) }}"
                            ...
                            <i class="fa-regular fa-flag"></i> <span>Report this Listing</span>
                        </a>
                </div>
            </div>
        </div>
...
<div id="booking-enquiry-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60" style="overflow-y:auto;">
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-lg mx-4 my-6 p-6 relative">
        ...
        <h2 class="text-xl font-bold text-pink-600 mb-1 flex items-center gap-2"><i class="fa-regular fa-envelope"></i> Send enquiry</h2>
