                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                @foreach($profile['videos'] ?? [] as $videoUrl)
                                    <div class="relative" x-data="{ playing: false, error: false }">
                                        ...
                                        <div x-show="!playing && !error" x-transition class="absolute inset-0 flex items-center justify-center pointer-events-none">
                    ...
                    <div class="bg-white rounded-2xl shadow p-6 border border-gray-100 mb-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            @if($profile['is_verified'])
                                <span class="ml-1 inline-flex items-center px-2 py-0.5 rounded bg-blue-100 text-xs font-semibold text-blue-700">
                                    <i class="fa-solid fa-badge-check text-blue-500 mr-1"></i> PHOTOS VERIFIED
                                </span>
                            @endif
                        </div>
                        ...
                        @if(!empty($primaryPhone) || !empty($profile['website']) || !empty($profile['onlyfans']) || !empty($profile['contact_method']))
                            <div class="mt-4">
                                ...
                                @if(!empty($primaryPhone))
                                    ...
                                    <a href="tel:{{ $phoneHref }}" aria-label="Call {{ $primaryPhone }}" class="block text-2xl font-bold tracking-wide mb-2 text-black hover:text-pink-600 transition">
                                        {{ $primaryPhone }}
                                    </a>
                                @endif
                                ...
                                @if(!empty($profile['website']))
                                    ...
                                    <a href="{{ $profile['website'] }}" class="block text-pink-600 font-semibold text-base hover:underline break-all mb-2" target="_blank" rel="noopener noreferrer">
                                        {{ $profile['website'] }}
                                    </a>
                                @endif
                                ...
                                @if(!empty($profile['onlyfans']))
                                    ...
                                    <a href="{{ $profile['onlyfans'] }}" class="block text-pink-600 font-semibold text-base hover:underline break-all mb-2" target="_blank" rel="noopener noreferrer">
                                        {{ $profile['onlyfans'] }}
                                    </a>
                                @endif
                            </div>
    ...
    >
        ...
        >
            <button
                ...
                class="absolute top-4 right-4 text-gray-400 hover:text-gray-700 text-2xl font-bold leading-none"
            >&times;</button>

            <h2 class="text-xl font-bold text-pink-600 mb-1 flex items-center gap-2">
            ...
            <div
                x-show="reportSuccess"
                x-text="reportSuccess"
                class="mb-4 p-3 bg-green-50 border border-green-200 rounded-xl text-green-700 text-sm font-medium"
            ></div>
            ...
            <form id="report-form" @submit.prevent="submitReport">
                ...
                <div class="mb-4">
                    ...
                    <textarea
                        ...
                        maxlength="2000"
                        class="w-full border border-gray-300 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-pink-300 resize-none"
                    ></textarea>
                </div>
                ...
                <div class="flex gap-3">
                    ...
                    <button
                        ...
                        class="flex-1 bg-pink-600 hover:bg-pink-700 text-white rounded-xl px-4 py-2 text-sm font-semibold transition disabled:opacity-60 disabled:cursor-not-allowed"
                        x-text="reportSubmitting ? 'Submitting...' : 'Submit Report'"
                    ></button>
                </div>
            </form>
        </div>
