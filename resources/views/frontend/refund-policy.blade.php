...
<div class="min-h-screen bg-gray-50" x-data="{}">
    <main class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div class="min-h-[600px] rounded-lg bg-white p-6 shadow-sm sm:p-8">
            ...
            <h1 class="text-3xl font-bold text-gray-900">Refund Policy</h1>
            <p class="mt-2 text-gray-600 {{ $policy?->updated_at ? 'mb-2' : 'mb-8' }}">Review our refund eligibility, timelines, and payment handling rules.</p>
            ...
            <div class="border border-gray-300 rounded-lg p-6">
                ...
                @else
                    <p class="text-gray-500">Refund policy is not available yet.</p>
                @endif
            </div>
        </div>
    </main>
