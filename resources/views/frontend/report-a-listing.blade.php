...
<div class="min-h-screen bg-gray-50 py-10 px-4 sm:px-6 lg:px-8">
    <div class="max-w-5xl mx-auto">
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8 mb-6">
            ...
            <p class="mt-3 text-gray-600">Find out how to report inappropriate or misleading listings on our platform.</p>
            @if($page?->updated_at)
                <p class="mt-3 text-sm text-gray-500">Last updated: {{ $page->updated_at->format('M d, Y') }}</p>
            @endif
        </div>
        ...
        @else
            <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6 text-gray-500">
                Report a listing information is not available yet.
            </div>
        @endif
    </div>
</div>
