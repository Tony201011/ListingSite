...
<div class="bg-[#f8fafc] min-h-screen py-10 text-gray-900">
    <div class="max-w-3xl lg:max-w-4xl mx-auto px-5">
        <div class="flex items-center justify-between flex-wrap gap-4 mb-8">
            <h2 class="text-3xl sm:text-4xl font-bold text-gray-900 tracking-tight">Set a new HOTESCORTS password</h2>
        </div>
        ...
        <div class="bg-white rounded-2xl p-6 md:p-8 mb-8 shadow-md border border-gray-100">
            <div class="flex items-center gap-4 mb-5">
                ...
                <h3 class="text-2xl md:text-3xl font-bold text-gray-800">Choose a new password</h3>
            </div>

            <p class="text-gray-600 mb-3 text-lg">Create a strong new password for your account.</p>
        ...
        <div x-data="resetPasswordForm()" class="bg-white rounded-2xl p-6 md:p-10 shadow-md border border-gray-100">
            ...
            <form method="POST" action="{{ route('password.update') }}" @submit="submitForm">
                ...
                <div class="mb-6" data-field-group>
                    <label for="reset_email" class="block font-semibold text-gray-800 mb-1">
                ...
                <div class="mb-6 relative" data-field-group>
