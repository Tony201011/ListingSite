                ...
                <table role="presentation" width="640" cellspacing="0" cellpadding="0" style="max-width:640px;width:100%;background:#ffffff;border:1px solid #f1f5f9;border-radius:14px;overflow:hidden;">
                    ...
                    <tr>
                        <td style="background:linear-gradient(90deg,#e04ecb,#c13ab0);padding:24px 28px;">
                            ...
                            <div style="font-size:14px;color:#fdf2f8;margin-top:6px;">Verify your email address</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:28px;">
                            ...
                            <p style="margin:0 0 18px 0;font-size:15px;line-height:1.7;color:#4b5563;">
                                Thank you for signing up. To activate your account and start using our platform, please verify your email address by clicking the button below.
                            </p>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" style="margin:0 0 20px 0;">
                                <tr>
                                    <td style="background:#e04ecb;border-radius:999px;">
                                        <a href="{{ $verificationUrl }}" style="display:inline-block;padding:12px 22px;font-size:14px;font-weight:700;color:#ffffff;text-decoration:none;">
                            ...
                            <div style="background:#fdf2f8;border:1px solid #fbcfe8;border-radius:10px;padding:14px 16px;margin-bottom:18px;">
                                <div style="font-size:12px;text-transform:uppercase;letter-spacing:0.08em;color:#9d174d;margin-bottom:6px;font-weight:700;">
                                    Registered Email
                                </div>
                            ...
                            <!-- Fallback Link -->
                            <p style="margin:0 0 12px 0;font-size:13px;line-height:1.7;color:#6b7280;">
                                If the button above does not work, copy and paste the following link into your browser:
                            </p>

                            <p style="word-break:break-all;font-size:12px;color:#2563eb;margin:0 0 18px 0;">
                                {{ $verificationUrl }}
                            </p>
