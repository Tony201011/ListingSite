        ...
        <div class="overflow-hidden rounded-3xl border border-pink-100 bg-white shadow-lg shadow-pink-100/40">
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div class="rounded-2xl border border-gray-100 bg-gray-50 p-4">
                        ...
                        <p class="mt-2 text-base font-semibold text-gray-900">
                            Use this feature up to {{ $onlineMaxUses }} times a day for {{ $onlineDurationMinutes }} minutes.
                        </p>
                    </div>
            ...
            >
                ...
                <p class="mb-6 text-sm font-medium text-pink-600">
                    Promote your availability {{ $availableMaxUses }} times a day for {{ $availableDurationMinutes }} minutes.
                </p>
