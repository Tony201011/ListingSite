...
@section('title', 'Escort Reviews')

@section('content')
<div class="min-h-screen bg-gray-50 py-10 px-4 sm:px-6 lg:px-8">
    <div class="max-w-5xl mx-auto">
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8 mb-6">
            <h1 class="text-3xl sm:text-4xl font-bold text-gray-900 tracking-tight">Escort Reviews</h1>
            <p class="mt-3 text-gray-600">Read and learn about our escort review policy and experiences.</p>
        </div>

        @if(!empty($escortReviewPage?->content))
