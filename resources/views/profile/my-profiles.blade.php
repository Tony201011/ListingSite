        ...
        >
            ...
            >
                <div class="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl" @click.stop>
                    ...
                    @if($reviewerMode ?? false)
                        <div class="mb-4 flex items-start gap-2 rounded-lg border border-amber-300 bg-amber-100 px-4 py-3 text-sm font-medium text-amber-900">
                            <svg xmlns="http://www.w3.org/2000/svg" class="mt-0.5 h-4 w-4 shrink-0 text-amber-600" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                            </svg>
                            <span>Reviewer mode is read-only. This form is displayed for processor review only.</span>
                        </div>
                    @endif
