...
@section('content')
<div class="min-h-screen bg-gray-50 py-8 px-4 sm:py-10 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
        @include('profile.partials.back-to-settings')
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 sm:p-8">
            <h1 class="text-xl sm:text-3xl font-bold text-gray-900 mb-2 sm:mb-3">My Babe Rank</h1>
            <p class="text-sm sm:text-base text-gray-600 mb-5 sm:mb-6">Track your current performance and top actions to improve ranking.</p>
            ...
            @if($shortCode)
            <div class="mb-5 sm:mb-6 rounded-xl border border-pink-200 bg-pink-50 p-4">
                ...
                <p class="text-xs text-pink-600 mt-1 break-all">Share this code with clients: <span class="font-semibold">{{ url($shortCode) }}</span></p>
            </div>
            @else
            <div class="mb-5 sm:mb-6 rounded-xl border border-gray-200 bg-gray-50 p-4">
